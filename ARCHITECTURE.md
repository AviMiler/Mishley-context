...
| `rescanCodeProject(projectId)`                      | Re-verifies (or re-requests) folder permission, then rescans (passing `project.ignorePatterns`) + rebuilds `depGraph` + re-syncs documents |
