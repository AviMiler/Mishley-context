...
- [ ] Manually verify project-instructions auto-load: select a project with instructions, open a fresh chat, confirm GM + instructions arrive in ONE message and the "נטען אוטומטית" badge shows on the instructions card. Also confirm a project with *no* instructions doesn't fire, and that documents are NOT included.
